...
> **Fork notes (for my own reference):** I'm using this fork primarily to experiment with crypto data from Binance. 
> The fine-tuning scripts released on 2025.08.17 are the main thing I'm exploring here. 
> Reminder to self: test with 1h and 4h intervals before moving to daily candles.
